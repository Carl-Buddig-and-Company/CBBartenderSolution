...
Namespace CB.Bartender.Models
    ...
    ''' Author: Brian Kinser
	''' Date: 8/13/2020
	''' Purpose:  Contains information about printers installed on the server.
    ''' </summary>
...
#Region "Methods"
        ...
        ''' </summary>
        ''' 
        Public Shared Function GetServerPrinters() As List(Of ServerPrinterInfo)
        ...
        ''' <returns>ServerPrinterInfo</returns>
        Public Shared Function GetServerPrinters(_name As String) As ServerPrinterInfo
            Dim printerInfo As New ServerPrinterInfo()

            Dim query As String = $"SELECT Name,PortName,Location,DriverName,Default FROM Win32_Printer WHERE Name = '{_name}'"
